<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="virtualterminal.aspx.cs" Inherits="virtualterminal" Title="E-Commerce Exchange - Merchant Account And Payment Gateway"
    Theme="Admin" %>
                    ...
                    <table class="Border">
                        ...
                        <tr>
                            <td align="left" valign="middle" style="width: 3%">
                                <img src="images/bullet.gif" height="8" width="8" border="0"></td>
                            <td align="left" valign="top">
            ...
            <td align="left" valign="middle" colspan="4">
                ...
                <asp:Panel ID="pnlConfig" runat="server" Width="700px" CssClass="Border">
                    <span class="LabelsBody">You may find it cumbersome to have to fill in every field to do
                        ...
                        <br />
                        <br />
                        Some configuration changes may only be made by your E-Commerce Exchange reseller

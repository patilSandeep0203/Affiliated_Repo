...
public partial class Join : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (SignupType == "Agent")
                lnkAgreement.NavigateUrl = "https://www.firstaffiliates.com/Partner Agreements/Agents/IC Agreements and paperwork/Independent Contractor Agreement-Agent.pdf";
            else if (SignupType == "Reseller")
                lnkAgreement.NavigateUrl = "https://www.firstaffiliates.com/Partner Agreements/Resellers/IC Agreements and paperwork/Independent Contractor Agreement-Reseller.pdf";
    ...
    public void Populate()
    {
        ...
        if (Request.Cookies["AffiliateWizAffiliateID"] == null)
        {
                ...
                if (Validate())
                {
                    ...
                    else
                    {
                        ...
                        */
                        ...
                        Response.Redirect("../partner/index.aspx?NewSignup=True&SignupType=" + lblSignup.Text, false);
                    }
                }//end if validate
            }//end if page valid
        }//end try
    ...
    public void SendEmail(string strMail)
    {
        try
        {
            ...
            string strSubject = "E-Commerce Exchange - New " + lblSignup.Text + " Signup";

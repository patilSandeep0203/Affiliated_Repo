<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="MobilePayments.aspx.cs" Inherits="MobilePayments" 
    Title="E-Commerce Exchange - Wireless Solutions" Theme="Admin"%>
        ...
        <tr>
            <td colspan="2">
                <table width="100%" align="center" cellspacing="0" cellpadding="0" border="0">
                    <tr>
                        <td align="left">
                            <a class="Link" href="GoPayment.aspx"><img border="0" src="Images/gopayment.jpg" alt="GoPayment" width="125px" /></a>
                        </td>
                        <td align="left">
                        ...
                        <td width="20%"></td>
                        <td align="left">
                            <a class="Link" href="ROAMpay.aspx"><img border="0" src="Images/ProductImages/ROAMpay.gif" alt="ROAMpay" width="125px" /></a>
                        </td>
                        <td align="left">
                            <a class="Link" href="ROAMpay.aspx">ROAMpay</a>                        
                        </td>
                    </tr>
                </table>
            </td>

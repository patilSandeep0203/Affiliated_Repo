<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="shopcart.aspx.cs" Inherits="shopcart" Title="E-Commerce Exchange - Shopping Carts"
    Theme="Admin" %>
...
<br />
    ...
    <table align="right" width="98%" cellspacing=2 cellpadding=0 border=0 class="DivWhiteSmoke;">
        <tr>
            ...
            <td align=center  class="DivHeader" valign=middle width="120px">
                <span class="MenuHeader"><b>Optimal Payments/Fire pay/NETBANX</b></span></td>            
            <td align=center class="DivHeader" valign=middle width="120px">
                <span class="MenuHeader"><b>Plug'n Pay</b></span></td>
            <td align=center  class="DivHeader" valign=middle width="120px">
                <span class="MenuHeader"><b>Quickbooks/ QB Merchant services</b></span></td>
            <td align=center  class="DivHeader" valign=middle width="120px">
                <span class="MenuHeader"><b>Sage</b></span></td>
        ...
        <tr>
            <td align=left valign=middle>
            <span class="LabelsBody"><a href="http://www.visioncoursemedia.com/" class="Link" target="_blank">ProStores</a></span></td>
            <td align=center valign= middle><img src="Images/check2.bmp" /></td>
            <td align=center valign= middle></td>
            <td align=center valign= middle></td>
            <td align=center valign= middle><img src="Images/check2.bmp" /></td>
        ...
        <tr>
            ...
            <td align=center valign= middle><img src="Images/check2.bmp" /><br/></td>
            <td align=center valign= middle></td>

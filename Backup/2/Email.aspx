<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Email.aspx.cs" Inherits="Email" Title="E-Commerce Exchange - Merchant Account And Payment Gateway"
    Theme="Admin" %>
...
<br />
    ...
    <table align="center" width="95%" cellspacing="0" cellpadding="5" border="0">        
        <tr>
            <td>
                <span class="LabelsBody">Complete this email form if you have a questions about or for E-Commerce Exchange. Please include best contact methods (phone and/or email) and best times to reach you. Mark the checkbox to send a copy of the 

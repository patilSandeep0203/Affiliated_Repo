...
public partial class MasterPage : System.Web.UI.MasterPage
{
            ...
            try
            {
                ...
                if ((AffiliateID != 0) && (AffiliateID != null))
                {
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        lblPartnerName.Text = "E-Commerce Exchange";
                    ...
                    lnkOnlineApp.NavigateUrl = "https://www.firstaffiliates.com/OnlineApplication/Start.aspx" ;
                    lnkOnlineApp.Target = "_blank";
                }
    ...
    public string GetBody()
    {
        ...
        if (ck != null)
            AffiliateID = Convert.ToInt32(ck["AffiliateID"].ToString().Trim());
        string Body = "Thank you for taking the time to fill out our form." + System.Environment.NewLine + "UNDERSTAND E-COMMERCE IN 2 MINUTES" + System.Environment.NewLine + "by E-Commerce Exchange" + System.Environment.NewLine + System.Environment.NewLine;
        ...
        Body = Body + "Sign up for a Merchant Account or a Payment Gateway with E-Commerce Exchange by clicking on the following link:" + System.Environment.NewLine;

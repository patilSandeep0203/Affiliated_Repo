<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="prodservices.aspx.cs" Inherits="prodservices" Title="E-Commerce Exchange - Merchant Account And Payment Gateway"
    Theme="Admin" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <table width="98%" cellspacing="2" cellpadding="0" border="0" align="right">
        ...
        <tr>
            ...
            <td valign="top">
                <a class="Link" href="merchmaster.aspx">
                    Merchant Master Software</a></td>
        ...
        <tr>
            ...
            <td align="left" valign="top">
                ...
                services and solutions. Secure your e-commerce web site with strong industry-standard 128/256 bit encryption with 
        ...
        <tr>
            ...
            <td valign="top" align="left">
                <span class="LabelsBodySmall">A merchant account is
                    a commercial account which allows you to accept credit card transactions. E-Commerce
                    Exchange's strong bank relationship ensures an unprecedented 95% approval rate for
        ...
        <tr>
            ...
            <td valign="top" align="left">
                <span class="LabelsBodySmall">Businesses that do not
                    ...
                    merchant account from E-Commerce Exchange, you will be able to accept credit cards

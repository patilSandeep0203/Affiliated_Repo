<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CheckServices.aspx.cs" Inherits="CheckServices" 
    Title="E-Commerce Exchange - Check Services" Theme="Admin"%>
    ...
    <table width="95%" align="center" cellspacing="0" cellpadding="0" border="0">
        ...
        <tr>
            <td align="left">
                ...
                <ul class="Bullet">
                    <li class="LabelsBody">61% of the buying public does not have a major credit card and 83% of the total consuming public write personal checks when shopping. </li>
                    <li class="LabelsBody">Automated Clearing House (ACH) transactions increased from 14.6 billion payments in 2006 to 19.1 billion payments in 2009. </li>
                    <li class="LabelsBody">96% of all checks are now electronified during the clearing process as opposed to 43% in 2006.</li>

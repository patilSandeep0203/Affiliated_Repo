<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="weblink.aspx.cs" Inherits="weblink" Title="E-Commerce Exchange - Merchant Account And Payment Gateway"
    Theme="Admin" %>
    ...
    <table width="95%" cellspacing="0" cellpadding="0" border="0">
        ...
        <tr>
            <td align="left" valign="middle" colspan="2">
                <span class="LabelsBody">Automate credit card transactions
                    directly from your Website by integrating to the e-Commerce Payment Gateway via
        ...
        <tr>
            <td align="left" valign="middle" style="width: 3%">
                <img alt="" src="images/bullet.gif" border="0" height="8" width="8" />
            </td>
            <td align="left">

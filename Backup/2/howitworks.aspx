<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="howitworks.aspx.cs" Inherits="howitworks" Title="E-Commerce Exchange - Merchant Account And Payment Gateway"
    Theme="Admin" %>
                    ...
                    <tr>
                        <td valign="top" align="left" class="DivGreen" width=30%>
                            <span style="font-family: Arial; font-size: 10pt; color: #DD1100"><b>1. Customer places
                                ...
                                transmitted to the e-Commerce secure server, which is linked via a dedicated, leased
                        ...
                        <td valign="top" align="left" class="DivGreen" width=40%>
                            <span style="font-family: Arial; font-size: 10pt; color: #194390"><b>2. e-Commerce verifies
                                ...
                                is sent by the e-Commerce secure server via leased data line to the credit card
                                ...
                                data line to the e-Commerce secure server. The authorization is encrypted by the
                                e-Commerce server and transmitted in encrypted form back to the web server of the

<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="support.aspx.cs" Inherits="support" Title="E-Commerce Exchange - Merchant Account And Payment Gateway"
    Theme="Admin" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <table width="90%" cellspacing="0" cellpadding="0" border="0">
        ...
        <tr>
            ...
            <td align="left" valign="top">
                <a class="Link" href="#ProcessingElectroniccheck" onmouseover='status=" Processing Electronic check transactions with e-Commerce ";return true;'
                    onmouseout='status=""; return true;'><span style="font-family: Arial; font-size: 10pt;">
                        Processing Electronic check transactions with e-Commerce</span></a>
            </td>
        </tr>
        <tr>
            <td align="left" valign="middle">
        ...
        <tr>
            ...
            <td align="left" valign="top">
                <a class="Link" href="#WebLinktoacceptElectroniccheck" onmouseover='status=" Using e-Commerce WebLink to accept Electronic checks from your web site ";return true;'
                    onmouseout='status=""; return true;'><span style="font-family: Arial; font-size: 10pt;">
                        Using e-Commerce WebLink to accept Electronic checks from your web site</span></a>
            </td>
        </tr>
        <tr>
            <td align="left" valign="middle">
        ...
        <tr>
            ...
            <td align="left" valign="top">
                <a class="Link" href="#Electroniccheckaccount" onmouseover='status=" How do I obtain an e-Commerce Electronic check account? ";return true;'
                    onmouseout='status=""; return true;'><span style="font-family: Arial; font-size: 10pt;">
                        How do I obtain an eCommerce Electronic check account?</span></a>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="left" valign="middle" colspan="4">
                <span style="font-family: Arial; font-size: 10pt;">
                    <br />
                    The e-Commerce system supports the processing of Electronic check transactions.
                    You must have a e-Commerce Electronic check processing account in order to accept
                    Electronic checks.
                    <br />
                    <br />
                    ...
                    your e-Commerce Electronic check account, the e-Commerce system then debits your
                    customer's checking account and transfers the funds first into your e-Commerce Electronic
                    ...
                    <br />
                    <br />
                    The funds are deposited (by Electronic check) into the merchant's e-Commerce Electronic
                        check account and the customer's checking account is debited by the e-Commerce system
        ...
        <tr>
            <td align="left" valign="middle" colspan="4">
                <span style="font-family: Arial; font-size: 10pt;">
                    ...
                    remain in your e-Commerce Electronic check account until the funds have cleared
                    or until the transaction is "returned" or "charged back". The e-Commerce system
        ...
        <tr>
            <td align="left" valign="middle" colspan="4">
                <span style="font-family: Arial; font-size: 10pt;">
                    <br />
                    If you have a e-Commerce Electronic check account, the following e-Commerce features
                    ...
                    <br />
                    <br />
                    e-Commerce Virtual Terminal - (it is expanded to allow Electronic check transactions)
                    <br />
                    <br />
                    e-Commerce WebLink - (it is expanded to allow Electronic check transactions)
                    <br />
                    <br />
        ...
        <tr>
            <td align="left" valign="middle" colspan="4">
                <span style="font-family: Arial; font-size: 10pt;">
                    <br />
                    For the basics on using Virtual Terminal see the section entitled &quot;e-Commerce
                    Virtual Terminal" above. Once your e-Commerce account is configured for Electronic
        ...
        <tr>
            <td align="left" valign="middle" colspan="4">
                <a class="Link" name="WebLinktoacceptElectroniccheck"></a><span style="font-family: Arial;
                    font-size: 10pt;">
                    <b>Using e-Commerce WebLink To Accept Electronic Check From Your Web Site</b>
                </span>
            </td>
        </tr>
        <tr>
            <td align="left" valign="middle" colspan="4">
                <span style="font-family: Arial; font-size: 10pt;">Complete details on how to link your
                    web site to e-Commerce WebLink are provided in the section entitled &quot;e-Commerce
        ...
        <tr>
            <td align="left" valign="middle" colspan="4">
                <span style="font-family: Arial; font-size: 10pt;">The e-Commerce system provides excellent
                    ...
                    updated by the system with current information pertaining to your e-Commerce Electronic
        ...
        <tr>
            <td align="left" valign="middle" colspan="4">
                <span style="font-family: Arial; font-size: 10pt;">
                    ...
                    amount that has been transferred from your customers' accounts into your e-Commerce
                    ...
                    <br />
                    <br />
                    Funds transfer - (for funds that are being transferred from your e-Commerce
                    Electronic check account into your regular checking account)
                    <br />
                    <br />
                    Bank fees - (for miscellaneous fees associated with your e-Commerce Electronic
        ...
        <tr>
            <td align="left" valign="middle" colspan="4">
                <a class="Link" name="Electroniccheckaccount"></a><span style="font-family: Arial;
                    font-size: 10pt;">
                    <br />
                    <b>How Do I Obtain A e-Commerce Electronic Check Account?</b>
                    <br />
                </span>
            </td>
        </tr>

<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="contactus.aspx.cs"
    Inherits="contactus" Title="E-Commerce Exchange - Merchant Account And Payment Gateway"
    Theme="Admin" %>
                ...
                <table width="90%" cellspacing="2" cellpadding="2" border="0">
                    <tr>
                        <td align="center" colspan=3>
                            <span class="LabelsBody"><b><i>E-Commerce Exchange is committed
        ...
        <tr>
            <td align="left" valign="middle">
                <span class="LabelsBody">"After submitting an information
                    request form to E-Commerce Exchange, I received a prompt response from a representative

<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="echeck.aspx.cs" Inherits="echeck" Title="E-Commerce Exchange - Merchant Account And Payment Gateway"
    Theme="Admin" %>
    ...
    <table width="95%" border="0" cellspacing="0" cellpadding="5">
        <tr>
            <td align="left" valign="bottom">
                <span class="LabelsBody">Electronic Check Service is an E-Commerce Exchange payment service
                    that allows online and traditional merchants to accept and process electronic check
                    payments -- either directly from their website storefront or through the e-Commerce

<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="merchantsplash.aspx.cs" Inherits="merchantsplash" Title="E-Commerce Exchange - Merchant Account And Payment Gateway"
    Theme="Admin" %>
    ...
    <table align="right" cellspacing="2" cellpadding="0" border="0" style="width: 98%;">
        <tr>
            <td valign="middle" align="center" colspan="3" class="DivHeader">
                <span class="LabelsWhite"><strong>Visa, MasterCard and Diners Merchant Account Logins</strong></span></td>
        </tr>
        <tr>
            <td align="center" >
                <a class="Link" href="https://merchantcenter.intuit.com/innovative" target="_blank">
                <img alt="" src="images/bullet.gif" height="8" width="8" border="0" /></a>
            </td>
        ...
        <tr>
            ...
            <td align="left" width=25%>
                <a class="Link" href="https://merchantcenter.intuit.com/qbms" target="_blank">Intuit - QuickBooks/GoPayment</a><span class="LabelsBodyLarge"> *</span><span 
        ...
        <tr>
            <td align="center" >
                <a class="Link" href="https://iaccess.merchant-info.com/" target="_blank">
                    <img alt="" src="images/bullet.gif" height="8" width="8" border="0" /></a>
            </td>
            <td align="left">
                <a class="Link" href="https://iaccess.merchant-info.com/" target="_blank">iPayment, Inc.</a><span class="LabelsBodyLarge"> *</span><span 
                    style="vertical-align:top" class="LabelsBodySmall"> #</span>
            </td>
            <td align="left">
        ...
        <tr>
            ...
            <td align="left">
                <a class="Link" href="https://login.netbanx.com" target="_blank">
                    OptimalPayments</a><span class="LabelsBodyLarge"> *</span>
            </td>
            <td align="left">
                <span class="LabelsBody">Available for all merchants. Please call your sales consultant
                    to get set up.</span>
        ...
        <tr>
            ...
            <td align="left" >
                <a class="Link" href="https://www.myvirtualreports.com/" target="_blank">
                    Sage</a><span class="LabelsBodyLarge"> *</span> <span 
                    style="vertical-align:top" class="LabelsBodySmall"> #</span>
            </td>
            <td align="left">
                <span class="LabelsBody">Available for all merchants. Click on the link to the left and sign up under Merchant Login.</span><br />
                <a class="LinkSmall" href="http://www.sagepayments.com/videoplayer.aspx?pageid=OnlineReportingISO_skin" target="_blank">[View Demo]</a><br />
            </td>
        </tr>
        <tr>
            <td align="center">
                <a class="Link" href="https://www.myclientline.net/" target="_blank">
                    <img alt="" src="images/bullet.gif" height="8" width="8" border="0" /></a>
            </td>
            <td align="left" >
                <a class="Link" href="https://www.myclientline.net/" target="_blank">
                    CardConnect</a><span class="LabelsBodyLarge"> *</span> <span 
                    style="vertical-align:top" class="LabelsBodySmall"> #</span>
            </td>
            <td align="left">
        ...
        <tr>
            <td valign="bottom" align="left" colspan="3" >
                <span style="vertical-align:text-bottom" class="LabelsBodySmall">#</span><span class="LabelsBodySmall"> Acquires American Express One Point in addition to Visa and MC so American 
                Express Merchant Account detail will be located within this login rather than on the Non Bankcard American Express web site below.</span>
            </td>
        </tr>
        <tr>
            <td valign="middle" align="center" colspan="3" class="DivHeader">
        ...
        <tr>
            <td align="left" style="width: 8px">
                <a class="Link" href="https://secure.authorize.net">
                    <img alt="" src="images/bullet.gif" height="8" width="8" border="0" /></a>
            </td>
            <td align="left" width=25%>
                <a class="Link" href="https://secure.authorize.net" target="_blank">
                    Authorize.net</a>
            </td>
            <td align="left">
                <span class="LabelsBody">If you have a Login and Password only, click to log in to Authorize.net.<br />
                ...
                <a class="LinkSmall" href="https://test.authorize.net" 
                target="_blank">[Test Account -- Login: <b>AuthnetTest2</b> &nbsp; Password: <b>Succeed11</b>]</a><br />
                <a class="LinkSmall" href="https://test.authorize.net" 
        ...
        <tr>
        	<td align="left" style="width: 8px">
        	    <a class="Link" href="https://anet.vpos.authorize.net/"  target="_blank">
        	        <img alt="" src="images/bullet.gif" height="8" width="8" border="0" /></a>
        	</td>
        	<td align="left">
                <a class="Link" target="_blank" href="https://anet.vpos.authorize.net/">
			...
			<td align="left">
                ...
                <!--<a class="LinkSmall" href="https://anet.vpos.authorize.net/" 
        ...
        <tr>
            ...
            <td align="left" >
                <a class="Link" href="https://login.test.netbanx.com" target="_blank">OptimalPayments</a>
            </td>
            <td align="left">
                <span class="LabelsBody">If you have a Username and Password, click to log in to OptimalPayments.<br />
                    [Test Account -- User Name: <b>OptimalSales</b> &nbsp; Password: <b>Abcd12345</b>]</span><br />
            </td>
        </tr>
        <tr>
            <td align="left" style="width: 8px">
        ...
        <tr>
            <td align="left" style="width: 8px">
                <a class="Link" href="https://secure.quickcommerce.net/">
                    <img alt="" src="images/bullet.gif" height="8" width="8" border="0" /></a>
            </td>
            <td align="left" >
                <a class="Link" target="_blank" href="https://secure.quickcommerce.net/">
                    QuickCommerce</a>
            </td>
            <td align="left">
                <span class="LabelsBody">If you have a Login and Password only, click to log in to QuickCommerce.</span>
            </td>
        </tr>
        <!--<tr>
            <td align="left" style="width: 8px">
        ...
        <tr>
            <td align="left" style="width: 8px">
                <a class="Link" href="http://my.roamdata.com/myroam" target="_blank">
                <img alt="" src="images/bullet.gif" height="8" width="8" border="0" /></a>
            </td>
            <td align="left" >
                <a class="Link" href="http://my.roamdata.com/myroam" target="_blank">
            ...
            <td align="left">
                <span class="LabelsBody">If you have an Account ID, Login ID, and Password, click to log in to ROAMpay.<br /> </span>                    
                <span class="LabelsHeaderSmall">[Test Account -- Login: sagedemo  Password:12345]</span>
            </td>
        </tr>
        <tr>
            <td align="left" style="width: 8px">
        ...
        <tr>
            ...
            <td align="left" >
                <a class="Link" href="https://www.sagepayments.net/virtualterminal" target="_blank">
                    Sage Virtual Terminal</a>
            </td>
            <td align="left">
                <span class="LabelsBody">If you have an Account ID, Login ID, and Password, click to log
                    in to Sage Virtual Terminal.<br /></span>
                <span class="LabelsHeaderSmall">[Test Account -- Virtual Terminal ID and Username: <b>210640986100</b> &nbsp; Password: <b>sagevtdemo1</b>]<br />
                    </span>
            </td>
        </tr>    
        ...
        <tr>
            ...
            <td align="left" width=25%>
                <a class="Link" href="https://www.myonlinereports.com/WebUI/login.aspx"
                    target="_blank">Sage Payment Solutions EFT</a>
            </td>
            <td align="left">
                <span class="LabelsBody">If you have a Sage Payment Solutions EFT check service account, click here to
                    login.</span>
            </td>
        </tr>
        <tr>

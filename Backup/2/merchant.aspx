<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="merchant.aspx.cs" Inherits="merchant" Title="E-Commerce Exchange - Merchant Account And Payment Gateway"
    Theme="Admin" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <br />
    <table align="right" border="0" cellpadding="2" cellspacing="0" style="width:98%">
        <tr>
            <td align="center">
        ...
        <tr>
            <td align="left">
                ...
                the EMV compliant contactless equipment. E-Commerce Exchange will help you get set up quickly 
            ...
            <td align="left">
                ...
                <ul class="Bullet">
                    <li><b><span class="LabelsHeader">Discount Rate: </span></b>
                        ...
                        For instance, accepting a "Visa Business Card" credit card may cost more than regular transactions. 
                    ...
                    <li><b><span class="LabelsHeader">Transaction Fees: </span></b>
                        <span class="LabelsBody">This is a flat amount that you pay
                        for each transaction. Typical transaction fees range from 20 cents to 30 cents per
                        transaction.
                        </span>
                    </li>
                    <li><b><span class="LabelsHeader">Monthly Fees: </span></b>
                        <span class="LabelsBody">This is a flat amount that merchant pays for each transaction regardless of how much the transaction was for. 
                        In some cases a “batch settlement” is treated as a transaction and will be charged a transaction fee.
                        </span>
                </li>
                <li><b><span class="LabelsHeader">Monthly Fees: </span></b>
        ...
        <tr>
            <td align="left">
                <b><span class="LabelsHeader">
                   It is easy to get set up for a merchant account with E-Commerce Exchange. </span></b>
            </td>
        </tr>
        <tr>
            <td align="left">
                ...
                <li>
                        <span class="LabelsBody">Print and sign the pdf application and email/fax it to applications@ecenow.com /310-321-5410 or sign and submit electronically.
                        </span>
                </li>
                <li>
